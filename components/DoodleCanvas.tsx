  ...
  return (
    <>
      ...
      <motion.button
        ...
        className="fixed bottom-4 right-3.5 sm:bottom-6 sm:right-6 z-40 w-11 h-11 sm:w-14 sm:h-14 rounded-full bg-[#E8E8E6] shadow-lg border-2 border-black/10 flex items-center justify-center hover:scale-110 transition-transform"
