...
const SignatureAnimation = () => {
  ...
  return (
    ...
    >
      {/* Secret message - positioned below the signature */}
      <AnimatePresence>
        {showMessage && (
          <motion.div
          ...
          >
            {clickCount === 5
              ...
              : "🎉 You found the secret! Keep clicking!"}
            <div className="absolute -top-2 left-1/2 -translate-x-1/2 w-0 h-0 border-l-8 border-r-8 border-b-8 border-transparent border-b-[#E8E8E6]" />
          </motion.div>
        )}
      </AnimatePresence>
